...
//#  define crm_trace(fmt, args...)   crm_err("crm_trace: " __FILE__ ": " __LINE__ ": " __func__ ": " fmt , ##args)
#  define crm_trace(fmt, args...)   crm_notice("crm_trace: %s:%d: %s: " fmt, __FILE__, __LINE__, __func__, ##args)
